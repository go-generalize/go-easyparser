...
import (
	...
	"github.com/go-generalize/go-easyparser/testdata/success"
...
func TestParser_Parse(t *testing.T) {
	base := "github.com/go-generalize/go-easyparser/testdata/success"
		...
		},
		{
			...
			fields: fields{
				...
				Replacer: func(t types.Type) tstypes.Type {
					...
					if named.String() == "github.com/go-generalize/go-easyparser/testdata/replace/base.A" {
