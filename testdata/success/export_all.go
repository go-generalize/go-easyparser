...
var AllExportedType = map[string]tstypes.Type{
	"github.com/go-generalize/go-easyparser/testdata/success/base.Embedded": &tstypes.Object{
		Common: tstypes.Common{
			PkgName:  "main",
			Position: testutil.ParsePositionString("testdata/success/base/main.go:9:6"),
		},
		Name: "github.com/go-generalize/go-easyparser/testdata/success/base.Embedded",
	...
	"github.com/go-generalize/go-easyparser/testdata/success/base.Status": &tstypes.String{
		Common: tstypes.Common{
			PkgName:  "main",
	...
	"github.com/go-generalize/go-easyparser/testdata/success/base/pkg.Package": &tstypes.Object{
		Common: tstypes.Common{
			Position: testutil.ParsePositionString("testdata/success/base/pkg/pkg.go:3:1"),
		},
		Name: "github.com/go-generalize/go-easyparser/testdata/success/base/pkg.Package",
		Entries: map[string]tstypes.ObjectEntry{
			"data": {
				RawName: "Data",
				RawTag:  `json:"data"`,
	...
	"github.com/go-generalize/go-easyparser/testdata/success/base.EmbeddedInt": &tstypes.Number{
		Common: tstypes.Common{
			PkgName:  "main",
			Position: testutil.ParsePositionString("testdata/success/base/main.go:20:6"),
		},
		Name:    "github.com/go-generalize/go-easyparser/testdata/success/base.EmbeddedInt",
		RawType: types.Int,
	},
	"github.com/go-generalize/go-easyparser/testdata/success/base.Data": &tstypes.Object{
		Common: tstypes.Common{
			PkgName:  "main",
			Position: testutil.ParsePositionString("testdata/success/base/main.go:22:6"),
		},
		Name: "github.com/go-generalize/go-easyparser/testdata/success/base.Data",
		Entries: map[string]tstypes.ObjectEntry{
			"Time": {
				RawName:    "Time",
				Type:       &tstypes.Date{},
